package net.fabricmc.fabric_hider;

import net.fabricmc.api.ModInitializer;
import net.fabricmc.fabric_hider.mixin.MinecraftClientMixin;
...
public class ExampleMod implements ModInitializer {
	...
	public static final Logger LOGGER = LogManager.getLogger("fabric_hider");
